...
const aftrekken = () => {
	...
	const aftrekken = txtLinks - txtRechts;
	let resultaat = document.getElementById('txtOutput');
	resultaat.innerHTML = txtLinks+" - "+txtRechts+" = " + aftrekken;
}
...
const vermenigvuldigen = () => {
	...
	let txtRechts = document.getElementById('txtRechts').value;
	let resultaat = document.getElementById('txtOutput');
	let g1 = parseInt(txtLinks, 10);
	let g2 = parseInt(txtRechts, 10);
	let vermingvuldidt = g1*g2;
	resultaat.innerHTML = g1+" * "+g2+" = "+vermingvuldidt;
}

const delen = () => {
	let txtLinks = parseInt(document.getElementById('txtLinks').value);
	let txtRechts = parseInt(document.getElementById('txtRechts').value);
	let resultaat = document.getElementById('txtOutput');
	const output = txtLinks+" : "+txtRechts+" = "+ (txtLinks/txtRechts);
